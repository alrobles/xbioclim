// xbioclim_omp.h — OpenMP thread-count helper for CRAN compliance.
//
...
#ifndef XBIOCLIM_OMP_H
#define XBIOCLIM_OMP_H

#ifdef _OPENMP
#include <omp.h>
#include <cstdlib>

inline int xbioclim_safe_threads(int requested) {
