...
This vignette explains the internal architecture of **xbioclim** for
advanced users who want to extend, embed, or contribute to the package.
It covers:

- The relationship between xbioclim and the upstream **xbioclim** C++
  library
...
xbioclim is a faithful R port of
...
- **Minimal dependencies** – xbioclim depends only on the C++ standard
  library; xbioclim depends only on base R.
...
See `vignette("benchmarking", package = "xbioclim")` for timing
...
and xbioclim.  Symbols: *T̄ₘ* = monthly mean temp, *T̂ₘ* = monthly max
