...
This vignette explains the internal architecture of **rxbioclim** for
advanced users who want to extend, embed, or contribute to the package.
It covers:

- The relationship between rxbioclim and the upstream **xbioclim** C++
  library
...
rxbioclim is a faithful R port of
...
See `vignette("benchmarking", package = "rxbioclim")` for timing
...
and rxbioclim.  Symbols: *T̄ₘ* = monthly mean temp, *T̂ₘ* = monthly max
